  ...
  return (
    <>
      ...
      <div className="mdm-container">
        ...
        <div style={{ width: '280px', display: 'flex', flexDirection: 'column', gap: '0.75rem', background: '#fff', padding: '1rem', borderRadius: '0.75rem', border: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.02)' }}>
          {leftTabs.map((x) => {
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '1.5rem', minWidth: 0 }}>
          ...
          {activeTab === 'Industry' && (
            <div className="card" style={{ background: '#fff', borderRadius: '0.75rem', padding: '2rem', border: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.02)' }}>
              ...
              <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem', background: '#f9fafb' }}>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                    <tbody>
                      ...
                      {!loading && filteredIndustries.length === 0 && (
                        <tr>
                          <td colSpan={4} style={{ padding: '2rem', textAlign: 'center', color: '#6b7280', fontSize: '0.875rem' }}>No industries found</td>
                        </tr>
                      )}
                ...
                {/* Pagination controls */}
                <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '2rem', marginTop: '1.5rem', fontSize: '0.75rem', fontWeight: 600, color: '#4b5563', padding: '0 0.5rem', flexWrap: 'wrap' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <span>1–{filteredIndustries.length} of {filteredIndustries.length}</span>
                    <button style={{ border: 'none', background: 'none', cursor: 'pointer', fontWeight: 700, color: '#9ca3af' }}>&lt;</button>
                    <button style={{ border: 'none', background: 'none', cursor: 'pointer', fontWeight: 700, color: '#111827' }}>&gt;</button>
                  </div>
                </div>
            ...
            <div className="card" style={{ background: '#fff', borderRadius: '0.75rem', padding: '2rem', border: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.02)' }}>
              ...
              <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem', background: '#f9fafb' }}>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                    <tbody>
                      ...
                      {!loading && filteredMachines.length === 0 && (
                        <tr>
                          <td colSpan={4} style={{ padding: '2rem', textAlign: 'center', color: '#6b7280', fontSize: '0.875rem' }}>No machines found</td>
                        </tr>
                      )}
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '2rem', marginTop: '1.5rem', fontSize: '0.75rem', fontWeight: 600, color: '#4b5563', padding: '0 0.5rem', flexWrap: 'wrap' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <span>1–{filteredMachines.length} of {filteredMachines.length}</span>
                    <button style={{ border: 'none', background: 'none', cursor: 'pointer', fontWeight: 700, color: '#9ca3af' }}>&lt;</button>
                    <button style={{ border: 'none', background: 'none', cursor: 'pointer', fontWeight: 700, color: '#111827' }}>&gt;</button>
                  </div>
                </div>
            ...
            <div className="card" style={{ background: '#fff', borderRadius: '0.75rem', padding: '2rem', border: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.02)' }}>
              ...
              <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem', background: '#f9fafb' }}>
                ...
                <div style={{ background: '#fff', borderRadius: '0.5rem', border: '1px solid #e5e7eb', overflow: 'hidden' }}>
                  <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                    <tbody>
                      ...
                      {!loading && sparesSubTab === 'Spares' && filteredSpares.length === 0 && (
                        <tr>
                          <td colSpan={4} style={{ padding: '2rem', textAlign: 'center', color: '#6b7280', fontSize: '0.875rem' }}>No spares found</td>
                        </tr>
                      )}
                      ...
                      {!loading && sparesSubTab === 'Categories' && filteredCategories.length === 0 && (
                        <tr>
                          <td colSpan={4} style={{ padding: '2rem', textAlign: 'center', color: '#6b7280', fontSize: '0.875rem' }}>No categories found</td>
                        </tr>
                      )}
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '2rem', marginTop: '1.5rem', fontSize: '0.75rem', fontWeight: 600, color: '#4b5563', padding: '0 0.5rem', flexWrap: 'wrap' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <span>1–{sparesSubTab === 'Spares' ? filteredSpares.length : filteredCategories.length} of {sparesSubTab === 'Spares' ? filteredSpares.length : filteredCategories.length}</span>
                    <button style={{ border: 'none', background: 'none', cursor: 'pointer', fontWeight: 700, color: '#9ca3af' }}>&lt;</button>
                    <button style={{ border: 'none', background: 'none', cursor: 'pointer', fontWeight: 700, color: '#111827' }}>&gt;</button>
                  </div>
                </div>
            ...
            <div className="card" style={{ background: '#fff', borderRadius: '0.75rem', padding: '2rem', border: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.02)' }}>
              ...
              <div style={{ border: '1px solid #e5e7eb', borderRadius: '0.5rem', padding: '1.5rem', background: '#f9fafb' }}>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                    <tbody>
                      ...
                      {!loading && filteredSkills.length === 0 && (
                        <tr>
                          <td colSpan={4} style={{ padding: '2rem', textAlign: 'center', color: '#6b7280', fontSize: '0.875rem' }}>No skills found</td>
                        </tr>
                      )}
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '2rem', marginTop: '1.5rem', fontSize: '0.75rem', fontWeight: 600, color: '#4b5563', padding: '0 0.5rem', flexWrap: 'wrap' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <span>1–{filteredSkills.length} of {filteredSkills.length}</span>
                    <button style={{ border: 'none', background: 'none', cursor: 'pointer', fontWeight: 700, color: '#9ca3af' }}>&lt;</button>
                    <button style={{ border: 'none', background: 'none', cursor: 'pointer', fontWeight: 700, color: '#111827' }}>&gt;</button>
                  </div>
                </div>
          ...
          {!['Industry', 'Machine & Machine Type', 'Spares & Categories', 'Skills'].includes(activeTab) && (
            <div className="card" style={{ background: '#fff', borderRadius: '0.75rem', padding: '3rem 2rem', border: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.02)', textAlign: 'center' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🚧</div>
              <h2 style={{ fontSize: '1.25rem', fontWeight: 700, margin: '0 0 0.5rem 0', color: '#111827' }}>{activeTab}</h2>
              <p style={{ color: '#6b7280', fontSize: '0.875rem' }}>This section is under development</p>
            </div>
          )}
