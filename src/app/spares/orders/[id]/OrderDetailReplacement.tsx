    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ borderBottom: '1px solid #e5e7eb', display: 'flex', gap: '1.5rem' }}>
        <button 
          ...
          className={`tab-btn ${activeTab === 'replacement' ? 'tab-btn-active' : ''}`}
        >
      ...
      {activeTab === 'replacement' ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div className="detail-card">
            <h3 style={{ fontSize: '1.125rem', fontWeight: 600, color: '#111827', marginBottom: '1.25rem' }}>Replacement Request Details</h3>
                ...
                >
                  <div style={{ display: 'flex', position: 'relative', alignItems: 'center', minWidth: '800px', padding: '1rem 0' }}>
                    ...
                    {[
                      ...
                      { title: 'Replacement Requested', date: "21st March, 2025 at 11:06 AM", position: 'bottom' },
                      { title: 'Replacement In Process', date: "21st March, 2025 at 11:06 AM", position: 'top' },
