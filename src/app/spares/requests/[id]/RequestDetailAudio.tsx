...
export default function RequestDetailAudio({ request }: RequestDetailProps) {
  ...
  const [currentTime, setCurrentTime] = useState<number>(150); // 2 mins 30 secs
  const [duration] = useState<number>(210); // 3 mins 30 secs
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '1.5rem' }}>
        ...
        {/* Right column - Audio Uploaded */}
        <div className="detail-card" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', height: 'fit-content' }}>
          <h3 style={{ fontSize: '1.125rem', fontWeight: 700, color: '#111827', margin: 0 }}>Audio Uploaded</h3>
          ...
          <div style={{ 
            ...
            {/* Big Blue circle player graphic */}
            <div style={{
              width: '120px',
              height: '120px',
              borderRadius: '50%',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem', width: '100%', justifyContent: 'center' }}>
              ...
              <button 
                ...
                style={{ border: 'none', background: 'none', color: '#4b5563', cursor: 'pointer', padding: '6px' }}
              >
              ...
              <button 
                ...
                style={{ border: 'none', background: 'none', color: '#4b5563', cursor: 'pointer', padding: '6px', position: 'relative' }}
                title="Rewind 10s"
              >
                <RotateCcw size={20} />
                <span style={{ fontSize: '7px', fontWeight: 800, position: 'absolute', top: '55%', left: '50%', transform: 'translate(-50%, -50%)' }}>10</span>
              </button>
            ...
            <span style={{ fontSize: '0.75rem', color: '#9ca3af', fontWeight: 500 }}>Uploaded 3 Hrs Ago</span>
          </div>
        </div>
