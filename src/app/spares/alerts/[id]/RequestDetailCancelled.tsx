...
export default function RequestDetailCancelled({
  request,
  onUpdateStatus,
  onCancelRequest,
  showCancelModal,
  ...
  const [activeTab, setActiveTab] = useState<'cancellationDetails' | 'summary' | 'tracking'>('cancellationDetails');
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ borderBottom: '1px solid #e5e7eb', display: 'flex', gap: '1.5rem' }}>
        <button 
          onClick={() => setActiveTab('cancellationDetails')}
          className={`tab-btn ${activeTab === 'cancellationDetails' ? 'tab-btn-active' : ''}`}
        >
      ...
      {/* Content */}
      {activeTab === 'cancellationDetails' && (
        <div className="detail-card" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div>
            <h3 style={{ fontSize: '1.125rem', fontWeight: 600, color: '#111827', marginBottom: '1rem' }}>Cancellation Request Details</h3>
                ...
                >
                  <div style={{ display: 'flex', position: 'relative', alignItems: 'center', minWidth: '800px', padding: '1rem 0' }}>
                    ...
                    {[
                      ...
                      { title: 'Cancellation Requested', position: 'bottom' },
        ...
        <div className="modal-overlay">
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', color: '#dc2626' }}>
              <AlertCircle size={24} />
              <h3 style={{ fontSize: '1.125rem', fontWeight: 700, margin: 0 }}>Cancel Request</h3>
            </div>
            
            <p style={{ fontSize: '0.875rem', color: '#4b5563', margin: 0, lineHeight: 1.5 }}>
              Are you sure you want to cancel the request for order <strong>{request.id.toUpperCase()}</strong>? This action cannot be undone.
            </p>
