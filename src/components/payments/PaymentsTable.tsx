            ...
            <tr key={row.id} className="row-hover" style={{ borderBottom: '1px solid #f3f4f6' }}>
              ...
              <td style={{ padding: '1rem' }}>
                <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'center' }}>
                  <button onClick={activeTab === 'Dispute/Escalations' ? onViewDispute : undefined} className="btn-hover" style={{ padding: '0.5rem 0.75rem', borderRadius: '0.5rem', border: '1px solid #e5e7eb', backgroundColor: 'white', color: '#4b5563', fontSize: '0.75rem', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
